<footer class="bg-green-700 pt-10 pb-3 mx-auto">
    <div class="container mx-auto">
        <div class="flex flex-wrap">
            <div class="mb-5 w-full px-4 font-medium text-slate-300 md:w-1/3">
                ...
                <p>geokostid@gmail.com</p>
                <p>Jl. Bojong Rangkas, Ciampea</p>
                <p>Kabupaten Bogor</p>
                <div class="mt-3 flex items-center justify-start">
                    <a href="#" target="_blank"
                        class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-red-700 hover:bg-red-700 hover:text-white">
                    ...
                    <a href="#" target="_blank"
                        class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-black hover:bg-black hover:text-white">
                        <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <title>TikTok</title>
                            <path
                    ...
                    <a href="#" target="_blank"
                        class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-blue-500 hover:bg-blue-500 hover:text-white">
                        <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <title>Twitter</title>
                            <path
        ...
        <p class="text-center text-xs font-medium text-white">
            <span class="text-sm sm:text-center">© 2025 <a href="#" class="hover:underline">GeoKost.id™</a>. All Rights
                Reserved.
            </span>
        </p>
    </div>
